...
#define CS1231_SDIO_MODE_OUT    GPIO_Init(GPIOD,GPIO_PIN_7,GPIO_MODE_OUT_PP_LOW_FAST)
#define CS1231_SDIO_MODE_IN     GPIO_Init(GPIOD,GPIO_PIN_7,GPIO_MODE_IN_PU_NO_IT)
